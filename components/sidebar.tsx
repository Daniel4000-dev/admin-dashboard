...
const SideBar = () => {
  ...
  const asideStyle = classNames(
    "sidebar overflow-y-auto overflow-x-auto fixed light:bg-[#fff] text-gray-500 z-50 h-full shadow-lg shadow-gray-900/20 transition duration-300 ease-in-out w-[20rem]",
    {
