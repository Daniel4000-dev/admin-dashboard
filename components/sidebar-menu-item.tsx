...
const SideBarMenuItem = ({ item }: { item: SideNavItem }) => {
  ...
  const linkStyle =
    "flex items-center min-h-[40px] hfull text-sidebar-foreground py-2 px-4 hover:text-sidebar-muted-foreground hover:bg-sidebar-muted rounded-md transition duration-200";
